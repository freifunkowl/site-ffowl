...
# Modified by: Collimas at 2016-04-17
...
for SITE in "${SITES[@]}"
  do
    ...
    cd $DIR/gluon/
    make update
    make -j$CORES BROKEN=1 GLUON_BRANCH=stable GLUON_TARGET=ar71xx-generic V=s
    make -j$CORES BROKEN=1 GLUON_BRANCH=stable GLUON_TARGET=ar71xx-nand V=s
    make -j$CORES BROKEN=1 GLUON_BRANCH=stable GLUON_TARGET=mpc85xx-generic V=s
